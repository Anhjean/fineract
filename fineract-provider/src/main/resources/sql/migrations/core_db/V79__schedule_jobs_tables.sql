...
CREATE TABLE `scheduled_jobs` (
    ...
    `job_display_name` VARCHAR(50) NOT NULL COLLATE 'utf8mb4_unicode_ci',
    `cron_expression` VARCHAR(20) NOT NULL COLLATE 'utf8mb4_unicode_ci',
    ...
    `trigger_key` VARCHAR(500) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
    `job_initializing_errorlog` TEXT NULL COLLATE 'utf8mb4_unicode_ci',
...
CREATE TABLE `scheduled_job_runhistory` (
    ...
    `errormessage` VARCHAR(500) NULL DEFAULT NULL COLLATE 'utf8mb4_unicode_ci',
    `triggertype` VARCHAR(25) NOT NULL COLLATE 'utf8mb4_unicode_ci',
    `errorlog` TEXT NULL COLLATE 'utf8mb4_unicode_ci',
    PRIMARY KEY (`id`),
